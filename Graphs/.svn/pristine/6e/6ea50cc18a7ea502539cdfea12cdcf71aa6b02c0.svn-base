...
public class TraversalTesting {
    ...
    private class Dfs extends DepthFirstTraversal {
        ...
        protected Dfs(Graph G) {
            super(G);
            _traversed = new ArrayList<Integer>();
            _opposite = new ArrayList<Integer>();
        }
        ...
        protected ArrayList<Integer> getPostVisitArray() {
            return _opposite;
        }
    ...
    public void testBreadthSearch() {
        ...
        if (answer.equals(a1)) {
            ...
            assertEquals(b1.get(0), 5, 0.01);
            assertEquals(b1.get(1), 3, 0.01);
            assertEquals(b1.get(2), 4, 0.01);
            assertEquals(b1.get(3), 1, 0.01);
            assertEquals(b1.get(4), 2, 0.01);
        } else if (answer.equals(c1)) {
            assertEquals(c1.get(0), 5, 0.01);
            assertEquals(c1.get(1), 4, 0.01);
            assertEquals(c1.get(2), 3, 0.01);
            assertEquals(c1.get(3), 2, 0.01);
            assertEquals(c1.get(4), 1, 0.01);
        } else if (answer.equals(d1)) {
            assertEquals(d1.get(0), 5, 0.01);
            assertEquals(d1.get(1), 3, 0.01);
            assertEquals(d1.get(2), 4, 0.01);
            assertEquals(d1.get(3), 2, 0.01);
            assertEquals(d1.get(4), 1, 0.01);
        } else {
    ...
    public void testDepthSearch() {
        ...
        if (answer.equals(a1)) {
            ...
            assertEquals(b1.get(0), 5, 0.01);
            assertEquals(b1.get(1), 3, 0.01);
            assertEquals(b1.get(2), 2, 0.01);
            assertEquals(b1.get(3), 4, 0.01);
            assertEquals(b1.get(4), 1, 0.01);
        } else {
            throw new AssertionError("Error");
        }
    }
    ...
    public void testPostVisitSearch() {
        ...
        ArrayList<Integer> answer = postDepth.getPostVisitArray();
        if (answer.equals(a1)) {
            ...
            assertEquals(b1.get(0), 2, 0.01);
            assertEquals(b1.get(1), 3, 0.01);
            assertEquals(b1.get(2), 1, 0.01);
            assertEquals(b1.get(3), 4, 0.01);
            assertEquals(b1.get(4), 5, 0.01);
        } else {
            throw new AssertionError("Error");
        }
    }
